...
const Panel = Symbiont.resolve({
  ...
  show: function show(anchor) {
    ...
    if (!xulPanel) {
      ...
      xulPanel.setAttribute("id", this.panelId);
      ...
      '<bindings xmlns="http://www.mozilla.org/xbl">' +
        '<binding id="id" extends="' + originalXBL + '">' +
          '<resources>' +
            ...
            '<stylesheet src="' + this.panelStyle + '"/>' +
          '</resources>' +
        '</binding>' +
      '</bindings>';
    ...
    function waitForBinding() {
      ...
      if (xulPanel.firstChild.clientWidth != width) {
        xulPanel.firstChild.style.width = (width + (width - xulPanel.firstChild.clientWidth)) + 'px';
      }
    }
    waitForBinding();
